from fastapi import APIRouter, Depends, HTTPException, Body, Query, Path, Request, status
...
from open_webui.models.subscription import (
    Plans, Subscriptions, RedeemCodes, Payments,
    PlanModel, SubscriptionModel, RedeemCodeModel, PaymentModel
)
